---
title: "GET /api/contacts.csv — Export Contacts as CSV"
sidebarTitle: "CSV Export"
description: "GET /api/contacts.csv streams a CSV export of all contacts visible to the authenticated client, including subscription, tag, validation, and suppression columns."
---
