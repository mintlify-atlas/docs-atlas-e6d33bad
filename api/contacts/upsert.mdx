---
title: "POST /api/contacts — Upsert Contact"
sidebarTitle: "Upsert Contact"
description: "POST /api/contacts creates or updates a contact and subscription. Accepts email, audience, client, status, tags, verified, and email_validation fields."
---
