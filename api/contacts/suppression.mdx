---
title: "PATCH /api/contacts/{id}/suppression — Update Suppression State"
...
<ParamField body="status" type="string" required>
  The validation result. One of: `unknown`, `valid`, `invalid_syntax`, `no_mx`, `disposable`, `risky`, `manually_invalid`, `externally_validated`.
</ParamField>
